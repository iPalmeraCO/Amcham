...
class DFlip_ShortCode {
  ...
  public function book( $attr, $content = '', $multi = false ) {
    ...
    if ( !empty( $post_id ) && is_numeric( $post_id ) ) {
      ...
      $help_info = '<a href="' . $base->plugin_url . str_replace( " ", "-", $help_tip ) . '/">' . $help_tip . '</a>';
    ...
    //
      ...
      $html = '<div class="_df_book df-lite' . $class . '" id="' . $id . '" ' . $attrHTML . '><p class="df-raw-loading">Please wait while ' . $help_info . ' is loading.</p></div>';
    }
