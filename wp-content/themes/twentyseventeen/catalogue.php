...
<div class="loadercontainer">
	<img src="http://142.93.201.64/Amcham/wp-content/uploads/2019/09/loader-gif.gif" alt="">
</div>
...
<div class="container">
<?php 
define ("CATEVENTOID", 147);
   
   $category_id = CATEVENTOID;   
   $months = list_months_bycategory($category_id,"product");	

	
	$args = array('child_of' => CATEVENTOID, 'taxonomy' => "product_cat", 'lang' => 'en,es');
...
<div class="filtros row top5">
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
			...
			<select name="categoria" id="categoria">
						<option value="eventos">All</option>
		...
		<div class="row center w100 contbuscar">					
				<a class="btn-vermas" onclick="filter_posts_catalogo()" style="margin: 0px auto">SEARCH</a>	
		</div>
	
<div class="contenteventos"> 
	<?php 

	 $args = array( 'post_type' => 'product', 'posts_per_page' => -1, 'product_cat' => 'catalogue', 'lang' => 'en,es' );
   $r     = new WP_Query($args);
   ...
   //print_r($r);
				...
				<div class="row">
					<div class="col-md-6 margineventop paddingevents">
			      		...
			      		<div class="contentcircu contentevent">
			      			...
			      			<div class="btnvermas btnvermaseventos"><a class="btn-vermas" href="<?php echo get_permalink(); ?>"><span class="texto-btn">View more</span><span class="separador">|</span><span class="estilo-mas">></span></a></div>
			      		</div>
			      		<?php 
			      			if ($contador == 1 ) { ?>
    ...
    var filter_posts_catalogo = function(){
