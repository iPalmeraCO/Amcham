			  ...
			  <div class="conteventdeta">
			  				...
			  				<!--<div class="row">			  					
			  					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  datosevento">
			  						...
			  						<div class="alright topdiez"><a class="btn-vermas" href="#"><span class="texto-btn">Realizar pedido</span><span class="separador">|</span><span class="estilo-mas">+</span></a></div>
			  					</div>
			  				</div>-->
