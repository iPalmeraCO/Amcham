	...
	<div class="container ">
		<div class="contentsocios">
			<?php   
		      ...
		      define("BLOG",9);
		      $args = array('child_of' => BLOG, 'lang' => 'en,es');
		...
		<div>
			<div class="filtros row">
				...
				<div class="row center w100 contbuscar">					
						<a class="btn-vermas" onclick="filter_posts_by_category_blog(99,1)" style="margin: 0px auto">BUSCAR</a>	
				</div>
			</div>
							...
							<div class="col-md-6 margincircutop paddingoutl cont_blog_all">
					      		...
					      		<div class="contentcircu cont_txt_blog">
					      			...
					      			<div class="btnvermas btnvermasdos btn_blog">
					      				<a class="btn-vermas"  href="<?php echo get_permalink(); ?>"><span class="texto-btn">Ver más</span><span class="separador">|</span><span class="estilo-mas">+</span></a>
					      			</div>
					      		</div>
					      	</div>
					    <?php }
