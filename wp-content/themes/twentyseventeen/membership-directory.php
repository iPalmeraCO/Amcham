<?php /* Template Name: membership Directory */ 
get_header(); ?>
...
<div class="container bread">
	<div class="cont-bread sobre-amcham">
		<a class="home" href="<?php echo get_home_url(); ?>">
			<?php $currentlang = get_bloginfo('language'); if($currentlang=="en-US"):?>Home<?php else: ?>Inicio<?php endif; ?>
		</a>
	...
	<div class="container ">
		<div class="contentsocios">
			<?php   
			  ...
			  $arraycategories = array("Comercio" => "Commerce", "Agro-industria" => "Agro-industry", "Industria" => "Industry", "Servicios" =>"Services");
		    ?>
		</div>
		<div>
			<div class="filtros row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<select name="categoria" id="categoria">
								<option value="membership-directory">All</option>
						<?php foreach($subcategories as $category): ?>
								<option value="<?= $category->cat_ID ?>"><?= $arraycategories[$category->name] ?> </option>
						<?php endforeach; ?>
					</select>
				</div>	
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="row center w100 contbuscar">					
						<a class="btn-vermas" onclick="filter_posts_by_category(99,1)" style="margin: 0px auto">SEARCH</a>	
				</div>
			</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="contactomodal">
													<div class="datsocios">
									      				<p><span class="texto-azul-claro">Address:  </span><?php echo get_post_meta($post->ID, 'direccion', true); ?></p>
														<p><span class="texto-azul-claro">Phone:  </span><?php echo get_post_meta($post->ID, 'telefono', true); ?></p>
					      	...
					      	<div class="col-md-6 margincircutop" id="d<?= $post->ID; ?>">
					      		...
					      		<div class="contentcircu">
					      			...
					      			<div class="datsocios"><?php //the_excerpt(); ?>
					      				<p><i class="fas fa-map-marker-alt"></i><span class="texto-azul-claro">Address: </span><?php echo get_post_meta($post->ID, 'direccion', true); ?></p>
										<p><i class="fas fa-phone"></i><span class="texto-azul-claro">Phone:   </span><?php echo get_post_meta($post->ID, 'telefono', true); ?></p>
										...
										<p><i class="fas fa-bookmark"></i><span class="texto-azul-claro">Brands:   </span><?php echo get_post_meta($post->ID, 'marcas', true); ?></p>
...
<script type="text/javascript">
    ...
    var filter_posts_by_category = function(cat, npag){
    	//Filtrar todos
    	var cat_slug = "membership-directory";  
    	var nombre = "";
    	if (cat != -1){
