...
<div class="filtros row" style="margin-top: 40px;">
		...
		<div class="row center w100 contbuscar">					
				<a class="btn-vermas" onclick="filter_posts_by_date()" style="margin: 0px auto">SEARCH</a>	
		</div>
	</div>

   <div class="contentrevistasinaction"> 
	<div class="row contentrevistasinactionrwow" style="margin-top: 40px;">
<?php
	...
	while ( have_posts() ) : the_post(); ?>
	  <div class="col-lg-4 col-md-4 col-sm-12" style="margin-top: 0px;">
    ...
    var filter_posts_by_date = function(){
        ...
        jQuery.ajax({
            ...
            success: function(result){
                jQuery('.contentrevistasinactionrwow').html(result);
            },
