<?php /* Template Name: Singleevento2 */ 
get_header(); ?>
			  ...
			  <div class="conteventdeta">
			      			...
			      			<div class="row">
				  				...
				  				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 alcenter datosevento">
				  					...
				  					<div class="col-md-12 ">
				  						<span class="spandatosevento"><input type="text" class="inpcan" name="" value="3"></span>
				  					</div>
			  				...
			  				<div class="row">
			  					...
			  					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 alright datosevento">
			  						<div class="alright topdiez"><a class="btn-vermas" href="eventos-detalle-3"><span class="texto-btn">Siguiente</span><span class="separador">|</span><span class="estilo-mas">></span></a></div>
			  					</div>
			  				</div>
		...
		<div class="containerdett2 mtop7">
			...
			<div class="col-md-6 margineventop paddingevents">
			    ...
			    <div class="contentcircu contentevent">
			        ...
			        <div class="btnvermas btnvermaseventos"><a class="btn-vermas" href="#"><span class="texto-btn">Ver más</span><span class="separador">|</span><span class="estilo-mas">+</span></a></div>
			    </div>
