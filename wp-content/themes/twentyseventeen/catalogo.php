...
<div class="filtros row top5">
		...
		<div class="row center w100 contbuscar">					
				<a class="btn-vermas" onclick="filter_posts_catalogo()" style="margin: 0px auto">BUSCAR</a>	
		</div>
	
<div class="contenteventos"> 
	<?php 

	 $args = array( 'post_type' => 'product', 'posts_per_page' => -1, 'product_cat' => 'catalogo' );
   $r     = new WP_Query($args);
